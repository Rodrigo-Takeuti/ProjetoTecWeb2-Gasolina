    ...
    <div class="container-fluid" id="main">
        <div class="row">
            <div class="col-xs-8" id="left">
                ...
                <p>1) Em primeiro lugar, impostos. Quase 60 por cento (57,13%) do preço da gasolina é apenas imposto, 
                    ...
                    <p>2)A Petrobrás não é totalmente do governo. É uma Sociedade de Economia Mista. 
                ...
                <p><3)A gasolina brasileira não é 100% gasolina! O governo pode exigir que o percentual 
                ...
                <p>4) Houve um grande aumento do número de carros nos últimos anos, o que aumentou a demanda por 
                    combustível, deixando o setor ainda mais sensível a qualquer uma dessas variantes citadas.</p>
                
                <p>5) Entressafra de cana: os preços do álcool são afetados pelo período de entressafra da 
